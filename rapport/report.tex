...
\begin{align}
\vec{E}_t^{(1)}(r,\theta,z) &= \sum_{i=1}^{M} \left( {a_i}^{+} e^{-j\beta_i^{(1)} z} + {a_i}^{-} e^{+j\beta_i^{(1)} z} \right) \vec{e}_i^{(1)}(r,\theta) \\
\vec{H}_t^{(1)}(r,\theta,z) &= \sum_{i=1}^{M} Y_i^{(1)} \left( {a_i}^{+} e^{-j\beta_i^{(1)} z} - {a_i}^{-} e^{+j\beta_i^{(1)} z} \right) \vec{h}_i^{(1)}(r,\theta)
\end{align}

De même dans le \textbf{Guide 2} ($z \ge 0$):
\begin{align}
\vec{E}_t^{(2)}(r,\theta,z) &= \sum_{k=1}^{N} \left( {b_k}^{+} e^{-j\beta_k^{(2)} z} + {b_k}^{-} e^{+j\beta_k^{(2)} z} \right) \vec{e}_k^{(2)}(r,\theta) \\
\vec{H}_t^{(2)}(r,\theta,z) &= \sum_{k=1}^{N} Y_k^{(2)} \left( {b_k}^{+} e^{-j\beta_k^{(2)} z} - {b_k}^{-} e^{+j\beta_k^{(2)} z} \right) \vec{h}_k^{(2)}(r,\theta)
\end{align}
